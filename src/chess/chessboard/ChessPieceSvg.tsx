...
// from https://commons.wikimedia.org/wiki/File:Chess_Pieces_Sprite.svg
const PIECES: Record<"b" | "w", Record<PieceType, JSX.Element>> = {
  w: {
    k: (
      <g
        fill="none"
...
export function ChessPieceSvg(props: ChessPieceProps) {
  return (
    <svg height="100%" viewBox="-5 -5 55 55" width="100%">
